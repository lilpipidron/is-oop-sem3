...
public class ChooseAccountScenarioProvider : IScenarioProvider
{
    private readonly IBankAccountService _service;
    private readonly ICurrentBankAccountService _currentAccount;
    private readonly ICurrentUserService _currentUser;

    public ChooseAccountScenarioProvider(
        ...
        [NotNullWhen(true)] out IScenario? scenario)
    {
        ...
        scenario = new ChooseAccountScenario(_service, _currentUser);
        return true;
    }
}