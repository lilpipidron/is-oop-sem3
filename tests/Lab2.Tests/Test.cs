...
public class Test
{
    ...
    public void FullSuccessBuild()
    {
        ...
        pcBuild.WithCpu(new Cpu(3, 5, new PcSocket.AM2(), new Ivc(20, 4000, 900), new[] { 1600 }, 30, 10));
        pcBuild.WithMotherBoard(new Motherboard(new PcSocket.AM2(), 6, 6, new Chipset(new[] { 1600 }, null), 4, 4, new MotherBoardFormFactor.StandartAtx(), new Bios("Best", "Best", new[] { new Cpu(3, 5, new PcSocket.AM2(), new Ivc(20, 4000, 900), new[] { 1600 }, 30, 10) }), null));
        ...
        pcBuild.WithPcCase(new PcCase(new Dimension.HWDimension(100, 100), new[] { new MotherBoardFormFactor.StandartAtx() },  new Dimension.HWDDimension(100, 100, 100)));
    ...
    public void FailedBuild()
    {
        var pcBuild = new PcBuilder();
        pcBuild.WithCpu(new Cpu(3, 5, new PcSocket.AM2(), new Ivc(20, 4000, 900), new[] { 1600 }, 30, 10));
        pcBuild.WithMotherBoard(new Motherboard(new PcSocket.AM3(), 6, 6, new Chipset(new[] { 1600 }, null), 4, 4, new MotherBoardFormFactor.StandartAtx(), new Bios("Best", "Best", new[] { new Cpu(3, 5, new PcSocket.AM2(), new Ivc(20, 4000, 900), new[] { 1600 }, 30, 10) }), null));
        pcBuild.WithCoolingSystem(new CoolingSystem(new Dimension.HWDDimension(1, 1, 1), new[] { new PcSocket.AM2() }, 50));
        pcBuild.WithRam(new Collection<IRam>() { new Ram(2, new RamFormFactor.Dimm(), 4, 20, new Jedec("10-10-10-10", 20, 1600), null) });
        pcBuild.WithVideoCard(new VideoCard(new Dimension.HWDimension(1, 1), 5000, "1", 5, 20));
        pcBuild.WithSsd(new Ssd(1, 11200, 100, "SATA"));
